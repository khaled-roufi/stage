...
<html>
<head>
    <title>AjouterPouffe</title>
</head>
<body>

<fieldset> Ajouter un Pouffe </fieldset>
<div>
    <s:form action="validerpouffe.action"  method="post" enctype="multipart/form-data">
        ...
        <s:hidden name="type" value="pouffe"/>
