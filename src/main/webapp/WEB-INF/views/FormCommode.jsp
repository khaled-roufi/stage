...
<html>
<head>
    <title>AjouterCommode</title>
</head>
<body>

<fieldset> Ajouter Commode </fieldset>
<div>
    <s:form action="validercommode.action" enctype="multipart/form-data">
        ...
        <s:hidden name="type" value="commode"/>
